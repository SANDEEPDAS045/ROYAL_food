/* ============================================================
   app.js — Royal Foods Router · API · Modal · Toast · Clock
   ============================================================ */
...
const App = {
  ...
  sectionMeta: {
    dashboard: { title: 'Executive Dashboard',   sub: 'Overview' },
    tables:    { title: 'Table Floor Plan',      sub: 'Dining Control' },
    orders:    { title: 'Live Orders',           sub: 'Order Management' },
    menu:      { title: 'Culinary Catalogue',    sub: 'Menu Management' },
    customers: { title: 'VIP & Guest Directory', sub: 'Guest Relations' }
  },
  ...
  init() {
    ...
    document.getElementById('refresh-btn').addEventListener('click', () => {
      ...
      toast.show('Telemetry refreshed', 'info');
    });
